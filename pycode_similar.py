...
# Source : https://github.com/fyrestone/pycode_similar
    ...
    for index_candidate, func_info_candidate in func_info_list[1:]:
        ...
        for fi1 in func_info_ref:
            ...
            for fi2 in func_info_candidate:
                ...
                # print("fi1: ", fi1._func_name,"\n", fi1.func_code)
                # print("fi2: ", fi2._func_name,"\n", fi2.func_code)
                # print("diff: ", dv)
...
def main():
    ...
    for index, func_ast_diff_list in results:
        ...
        sum_plagiarism_percent, sum_plagiarism_count, sum_total_count = summarize(
            func_ast_diff_list)
